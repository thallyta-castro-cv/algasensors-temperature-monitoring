...
import com.algasensors.temperature.monitoring.api.model.SensorMonitoringResponseDTO;
...
public class SensorMonitoringController {
    ...
    @GetMapping
    public SensorMonitoringResponseDTO getDetail(@PathVariable TSID sensorId) {
